...
public class UserController {
    ...
    public ResponseEntity<UserDTO> registerUser(@Valid @RequestBody UserDTO userDTO) { // Expecting UserDTO
        UserDTO createdUser = userService.createUser(userDTO);  // Use DTO in service
