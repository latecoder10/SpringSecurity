package com.springJWT.authentication.config;
...
public class ApplicationConfig {
    ...
    public UserDetailsService userDetailsService() {
        return username -> userRepository.findByUsername(username) // Fetch by username instead of email
        		.map(UserPrincipal::new) // Map the User entity to UserPrincipal
